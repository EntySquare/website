...
<!--                       style="width:36px;height:36px;margin: -23px 0px 0px 105px;"/>-->
             ...
             <swiper-slide >
               <div style='height: 20px'></div>
               <v-navigation-drawer style='width: 400px;background: #FAFBFC;height: 190px;border-radius: 20px;box-shadow: 0px 4px 30px 0px rgba(0, 0, 0, 0.04);'>
                 <v-row style='padding: 36px 0px 0px 50px'>
                   <div class='d-inline-flex' style='width: 100%;'>
                     <div style='width: 160px;
                   ...
                   <p style='width: 95%;
                     ...
                     <span style='font-size: 38px;margin: 0px;padding: 0px'>248</span>
                     <span style='font-size: 28px;margin: 0px;padding: 0px'>.2%</span>
                     <span style='font-size: 14px;font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #808080;margin: 0px;padding: 0px 0px 0px 5px'>
                       年化收益
                     <img
